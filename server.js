...
const MEETING_DETAILS = `בפגישת הייעוץ האסטרטגית *עם מאור ברקת עצמו* (בין שעה לשעתיים), המבוססת על 18 שנות ניסיון, נעבור על:
...
function isVagueTime(text) {
  ...
  const hasDayOrTime = /ראשון|שני|שלישי|רביעי|חמישי|שישי|שבת|מחר|היום|בוקר|צהריים|ערב|לילה/.test(text || '');
  return !hasDigits && !hasDayOrTime;
}
